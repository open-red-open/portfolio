...
const skillsLogos = {
  ...
  ['Back' as string]: [
    ...
    {
      name: 'SpringBoot',
      image: '/logos/springboot_logo.png',
    },
    {
      name: 'Django',
      image: '/logos/django_logo.png',
    },
    {
      name: "Laravel",
      image: '/logos/laravel_logo.png',
    },
    {
      name: 'ExpressJS',
  ...
  ['Tools' as string]: [
    ...
    {
      name: 'ElasticSearch',
      image: '/logos/elasticsearch_logo.png'
    },
    { name: '', image: '' },
    { name: '', image: '' },
    { name: '', image: '' },
