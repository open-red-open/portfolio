...
export const sections = [
  ...
  { index: 1, title: 'Skills', id: 'skills' },
...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-skills_purple">Senior Software</span> engineer with experience in <span className="text-skills_purple">Front-End</span> and{' '}
  ...
  },
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Senior Software Enginner</span> with <span className="text-work_experience_orange">10 years</span> of experience in the software industry
        </div>
      ),
    },
  ...
  },
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          Some of <span className="text-my_work_yellow">my work</span> as a Senior <span className="text-my_work_yellow">Software</span> engineer
        </div>
      ),
    },
    mainContent: <MyWork />,
        ...
        <Container>
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              ...
              <p className="max-w-3xl">Senior Software Engineer with expertise in Front-End and Back-End development, Skilled in building scalable microservices, optimizing cloud infrastructure, and integrating AI/ML for performance and accuracy improvements in diverse industries, including e-commerce, Real Estate, and Booking etc.</p>
            </FadeIn>
