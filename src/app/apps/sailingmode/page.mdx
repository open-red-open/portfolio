...
import { sailingmode } from '../../../../public/projects';

export const appData = {
  industry: 'Booking',
  title: 'Sailing Mode',
  description: ' is a saas platform that allows you to deploy a real booking from a selection of templates within minutes.',
  image: sailingmode,
  date: '2018',
  service: 'Saas application',
  url: 'https://sailingmode.com/',
  pathname: '/apps/sailingmode',
  framework: 'angular',
};
...
<AppSolution image='sailingmode.png' href={appData.url}>
  
F is split in 3 different systems. Each of this systems is hosted in their own server and they communicate through apis.

The first system 'Booking' is a Angular application that faces the user. It is where a user can register, manage their subscription, and choose which template to deploy.
...
The second system 'Server' is a small express server that serves as a connection between the 'Booking' and the 'Worker' system. It's job is to recieve orders from the 'Shop'
